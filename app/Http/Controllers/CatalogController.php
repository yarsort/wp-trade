...
class CatalogController extends BaseController
{
    ...
    protected function getFile()
    {
        ...
        if ($file = fopen($fullPath, 'ab')) {
            ...
            if ($result === $dataLen) {
                ...
                $result = $this->writeToDB($fullPath, $fileName);
            }
    ...
    private function writeToDB ($fullPath, $fileName): bool
    {

        $xmlString = file_get_contents(public_path($fullPath));
        ...
        error_log('File name should be import.xml or offers.xml');
        return false;
    }
}
